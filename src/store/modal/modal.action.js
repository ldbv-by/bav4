...
/**
 * Opens the modal.
 * @param {string|TemplateResult} title The title of the modal. Could either be a plain string or a lit-html `TemplateResult`.
 * @param {string|TemplateResult} content  The content of the modal. Could either be a plain string or a lit-html `TemplateResult`.
 * @param {module:store/modal/modal_action~ModalOptions} options Options for the modal
 * @function
 */
