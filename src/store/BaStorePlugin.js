/**
* Abstract base class for all BaStorePlugins.
* Beside {@link BaElement},  BaStorePlugins are a second important place for structuring code and logic. 
...
* @author aul
*/
export class BaStorePlugin {


	constructor() {
		if (this.constructor === BaStorePlugin) {
