...
/**
 * A function that takes a `GhRoute` and optionally a corresponding `ProfileStats` object and returns statistics data for that route
 * @typedef {Function} routeStatsProvider
 * @param {module:domain/routing~GhRoute} route the route
 * @param {module:services/ElevationService~ProfileStats} [profileStats=null] statistic data of a profile of the route
