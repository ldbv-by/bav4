		...
		return [
			{
				...
				target: 'external', // required ["modal", "external", "internal"]
				observer: {
			...
			{
				id: 'web_vektor_relief',
				title: 'Web Vektor Relief', // required
				href: 'bmde_vector_relief', // required
				permanent: false, // required
				target: 'internal', // required ["modal", "external", "internal"]
				observer: {
					// required [object, null]
					geoResources: [
						// required
				...
				style: {
					...
					colorDark: 'var(--primary-color)', // required
					backgroundColorDark: 'var(--primary-bg-color)', // required
					icon: '<path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0"/><path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>'
				}
			},
			{
				id: 'smart_mapping',
