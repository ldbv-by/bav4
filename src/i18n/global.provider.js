	...
	switch (lang) {
		...
		case 'en':
			return {
				...
				global_store_geolocation_denied: 'The acquisition of the position failed because your browser settings does not allow it. Allow your browser / this website to use your location. Deactivate the "private" mode of your browser.',
				global_store_geolocation_not_available: 'The acquisition of the position failed.',
		...
		case 'de':
			return {
				...
				global_store_geolocation_denied: 'Es ist keine Positionsbestimmung möglich, da ihre Browsereinstellungen dies nicht zulassen. Erlauben sie die Positionsbestimmung und deaktivieren Sie den "Privat" Modus des Browsers.',
				global_store_geolocation_not_available: 'Es ist keine Positionsbestimmung möglich.',
