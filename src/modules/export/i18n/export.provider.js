	...
	switch (lang) {
		case 'en':
			return {
				...
				export_item_description_geojson: 'usable in BayernAtlas and many GIS-Applications',
		...
		case 'de':
			return {
				...
				export_item_download_gpx: '.gpx',
				export_item_label_geojson: 'GeoJSON',
				export_item_description_geojson: 'verwendbar im BayernAtlas und vielen GIS-Anwendungen',
				export_item_download_geojson: '.geojson',
				export_item_label_ewkt: 'EWKT',
