	...
	switch (lang) {
		case 'en':
			return {
				...
				export_item_description_kml: 'saves styles (symbols, color and width) and all geometrytypes',
				...
				export_item_description_geojson: 'saves styles (symbols, color and width) and all geometrytypes',
				export_item_download_geojson: '.geojson',
				export_item_label_ewkt: 'EWKT',
				export_item_description_ewkt: 'saves all geometrytypes, no styles',
