	...
	switch (lang) {
		case 'en':
			return {
				...
				elevationProfile_lineOfSight_attribute_label: 'Under line of sight',
				elevationProfile_lineOfSight_visible: 'No',
				elevationProfile_lineOfSight_geodeticLineOfSight: 'Geodetic line of sight',
				elevationProfile_lineOfSight_lastVisible: 'Last visible distance',
				elevationProfile_lineOfSight_observerHeight: 'Observer height (m)',
				elevationProfile_lineOfSight_target_visible: 'Target visible',
				elevationProfile_lineOfSight_target_visibility_deficit: 'Target under line of sight',
		...
		case 'de':
			return {
				...
				elevationProfile_lineOfSight_attribute_label: 'Unter der Sichtlinie',
				elevationProfile_lineOfSight_visible: 'Nein',
				elevationProfile_lineOfSight_geodeticLineOfSight: 'Geodätische Sichtweite',
				elevationProfile_lineOfSight_lastVisible: 'Letzte sichtbare Distanz',
				elevationProfile_lineOfSight_observerHeight: 'Beobachterhöhe (m)',
				elevationProfile_lineOfSight_target_visible: 'Zielpunkt sichtbar',
				elevationProfile_lineOfSight_target_visibility_deficit: 'Zielpunkt unter der Sichtlinie',
