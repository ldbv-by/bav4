	...
	switch (lang) {
		case 'en':
			return {
				...
				elevationProfile_lineOfSight_visibleDistancePercent: 'Visible distance (%)',
				elevationProfile_lineOfSight_observerHeight: 'Observer height (m)',
				elevationProfile_lineOfSight_target_visible: 'Target visible',
				elevationProfile_target_visibility_deficit: 'Target under line of sight',
		...
		case 'de':
			return {
				...
				elevationProfile_lineOfSight_visibleDistancePercent: 'Sichtbare Distanz (%)',
				...
				elevationProfile_target_visibility_deficit: 'Zielpunkt unter der Sichtlinie',
