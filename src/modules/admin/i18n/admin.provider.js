	...
	switch (lang) {
		case 'de':
			return {
				...
				admin_catalog_clipboard_notification: 'GeoRessource wurde erfolgreich in die Zwischenablage kopiert',
				admin_catalog_clipboard_error_notification: 'GeoResource konnte nicht in die Zwischenablage kopiert werden.',
				...
				admin_modal_delete_group_title: (params) => `Löschen der Gruppe "${params[0]}"`,
		...
		case 'en':
			return {
				...
				admin_catalog_empty_tree_hint: 'Add a new group or a GeoResource from the explorer.',
				...
				admin_catalog_clipboard_notification: 'GeoResource was successfully copied to clipboard',
				admin_catalog_clipboard_error_notification: 'Unable to copy GeoResource to clipboard',
				...
				admin_modal_delete_group_title: (params) => `Delete the group "${params[0]}"`,
