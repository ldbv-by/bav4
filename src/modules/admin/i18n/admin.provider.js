	...
	switch (lang) {
		case 'de':
			return {
				...
				admin_catalog_environment_stage: 'Testumgebung',
				admin_catalog_environment_production: 'Produktion',
		...
		case 'en':
			return {
				...
				admin_catalog_environment_stage: 'Test environment',
				admin_catalog_environment_production: 'Production',
