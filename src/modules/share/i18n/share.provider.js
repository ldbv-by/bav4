	...
	switch (lang) {
		case 'en':
			return {
				...
				share_dialog_api_failed: 'No Share API available – please use the “Copy” button',
		...
		case 'de':
			return {
				...
				share_dialog_api_failed: 'Keine Share‑API vorhanden – Bitte den Button „Kopieren“ verwenden',
