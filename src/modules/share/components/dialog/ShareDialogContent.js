		...
		if (url || fileSaveUrl) {
			return html`<style>
				...
				<div class="infographic">
					${checkedToggle
						? unsafeHTML(infographic_share_collaborative)
						: unsafeHTML(getInfographicShareCopy(translate('share_dialog_infographic_original'), translate('share_dialog_infographic_copy')))}
				</div>
