	...
	switch (lang) {
		...
		case 'en':
			return {
				...
				map_olMap_layer_not_available: 'Failed to add a layer for id',
				...
				map_olMap_handler_draw_new_text: 'new text',
		...
		case 'de':
			return {
				//the first part of the snake_case key should be the name of the related module
				map_olMap_layer_not_available: 'Ebene konnt nicht geladen werden:',
				...
				map_olMap_handler_draw_new_text: 'Neuer Text',
