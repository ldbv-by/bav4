	...
	switch (lang) {
		case 'en':
			return {
				...
				olMap_handler_measure_modify_click_or_drag: 'Click to delete the point (2 points min.).<br/> Click then drag to move the point',
		...
		case 'de':
			return {
				...
				olMap_handler_measure_modify_click_or_drag: 'Klicke, um den Punkt zu löschen (mind. 2 Punkte).<br/> Punkt verschieben: klicken und ziehen',
