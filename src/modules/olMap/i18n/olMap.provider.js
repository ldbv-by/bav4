	...
	switch (lang) {
		case 'en':
			return {
				...
				olMap_handler_mfp_encoder_features_invalid: 'The following layers contain invalid objects:',
				olMap_handler_mfp_encoder_features_not_exported: 'The invalid objects will not be exported.',
		...
		case 'de':
			return {
				...
				olMap_handler_termsOfUse: (params) =>
					// prettier-ignore
					html`Ihre Zeichnung wird automatisch gespeichert. Durch die Nutzung dieses Dienstes stimmen Sie den <a href="${params[0]}" target="_blank" tabindex="0">Nutzungsbedingungen</a> zu.`,
				olMap_handler_mfp_distortion_warning:
				...
				olMap_handler_mfp_encoder_max_specs_limit_reached: 'Die zu exportierende Karte überschreitet die Größenbegrenzung.',
				olMap_handler_mfp_encoder_layer_not_exportable: 'Die folgenden Ebenen können nicht exportiert werden:',
				olMap_handler_mfp_encoder_features_invalid: 'Die folgenden Ebenen enthalten fehlerhafte Objekte:',
				olMap_handler_mfp_encoder_features_not_exported: 'Die fehlerhaften Objekte werden nicht exportiert.',
				olMap_handler_routing_choose_alternative_route: (params) => `${params[0]}`,
