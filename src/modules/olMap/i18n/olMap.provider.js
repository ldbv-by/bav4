	...
	switch (lang) {
		...
		case 'en':
			return {
				...
				olMap_handler_mfp_distortion_warning: 'Attention! The projection used for export has distortions in some areas which are not suitable for length measurements.',
		...
		case 'de':
			return {
				...
				olMap_handler_mfp_distortion_warning: 'Achtung! Die für den Export verwendete Projektion besitzt in einigen Bereichen\nVerzerrungen die nicht für Längenmessungen geeignet sind.',
