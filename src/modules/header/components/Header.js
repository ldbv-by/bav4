			...
			<div class="preload ${getOrientationClass()} ${getMinWidthClass()}">
				...
				<div  class="header ${getOverlayClass()}">  
					...
					<div class='header__search-container'>
						<input id='input' placeholder='${translate('header_search_placeholder')}' @focus="${onInputFocus}" @blur="${onInputBlur}" @input="${onInput}" class='header__search' type="search" placeholder="" />          
