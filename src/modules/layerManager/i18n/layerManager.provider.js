	...
	switch (lang) {
		case 'en':
			return {
				...
				layerManager_highlight: 'Highlight layer',
				layerManager_highlight_active: 'Remove highlight layer',
		...
		case 'de':
			return {
				...
				layerManager_highlight: 'Ebene hervorheben',
				layerManager_highlight_active: 'Ebene nicht hervorheben',
