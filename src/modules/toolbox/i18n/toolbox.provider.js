	...
	switch (lang) {
		...
		case 'en':
			return {
				...
				toolbox_measureTool_measure_active:'Click to start measurement',
				toolbox_measureTool_measure_draw: 'Click to continue drawing the line (double-click to finish)',
				toolbox_measureTool_measure_modify: 'Click on measurement, to add point.</br> Click then drag to move the point</br> Single click on the point to delete.',
		...
		case 'de':
			return {
				...
				toolbox_measureTool_measure_active: 'Klicken, um die Messung zu beginnen',
				toolbox_measureTool_measure_draw: 'Klicken, um die Messlinie zu zeichnen (Doppelklick zum Beenden)',
				...
				toolbox_measureTool_measure_select: 'bestehende Messung auswählen oder neue Messung beginnen',
