	...
	switch (lang) {
		case 'en':
			return {
				...
				routing_feedback_901: 'Specify <b>destination</b> by clicking in the map',
				routing_feedback_902: 'Specify <b>start</b> by clicking in the map',
				...
				routing_waypoints_as_start: 'start',
				routing_waypoints_as_destination: 'destination',
				routing_waypoints_title: 'Waypoints',
				routing_waypoints_remove_all: 'Remove all',
				routing_waypoints_remove_all_title: 'Remove all waypoints',
				routing_waypoints_reverse: 'Reverse',
				routing_waypoints_reverse_title: 'Reverse order of waypoints',
		...
		case 'de':
			return {
				...
				routing_feedback_901: '<b>Ziel</b> durch Klicken in die Karte angeben',
				routing_feedback_902: '<b>Start</b> durch Klicken in die Karte angeben',
				...
				routing_waypoints_as_start: 'Start',
				routing_waypoints_as_destination: 'Ziel',
				routing_waypoints_title: 'Wegpunkte',
				routing_waypoints_remove_all: 'Alle entfernen',
				routing_waypoints_remove_all_title: 'Alle Wegpunkte entfernen',
				routing_waypoints_reverse: 'Reihenfolge umkehren',
				routing_waypoints_reverse_title: 'Reihenfolge der Wegpunkte umkehren',
