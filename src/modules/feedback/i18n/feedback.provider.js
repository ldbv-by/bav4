export const provide = (lang) => {
	switch (lang) {
		case 'en':
			return {
				feedback_generalFeedback_changeDescription_error: 'Required field',
				feedback_generalFeedback_changeDescription_helper: 'Required field',
				...
				feedback_generalFeedback_eMail_error: 'No valid e-mail address',
				feedback_generalFeedback_eMail_helper: 'Optional',
				feedback_generalFeedback_eMail: 'Your email address',
				feedback_generalFeedback_header: 'General Feedback',
				feedback_generalFeedback_rating: 'Your Vote',
				feedback_generalFeedback_saved_successfully: 'Your feedback was successfully submitted',
		...
		case 'de':
			return {
				feedback_generalFeedback_changeDescription_error: 'Pflichtfeld',
				feedback_generalFeedback_changeDescription_helper: 'Pflichtfeld',
				...
				feedback_generalFeedback_eMail_error: 'Keine gültige E-Mail-Adresse',
				feedback_generalFeedback_eMail_helper: 'Optional',
				...
				feedback_generalFeedback_saved_successfully: 'Ihr Feedback wurde gespeichert',
				...
				feedback_mapFeedback_eMail_error: 'Keine gültige E-Mail-Adresse',
				feedback_mapFeedback_eMail_helper: 'Optional',
