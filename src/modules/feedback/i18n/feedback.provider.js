	...
	switch (lang) {
		case 'en':
			return {
				...
				feedback_add_current_state_optionally: 'Add current URL of the BayernAtlas for better traceability',
				feedback_generalFeedback_submit_title: 'Submit your general feedback',
				...
				feedback_mapFeedback_submit_title: 'Submit your map feedback',
		...
		case 'de':
			return {
				...
				feedback_add_current_state_optionally: 'Für bessere Nachvollziehbarkeit aktuelle URL des BayernAtlas hinzufügen',
				feedback_generalFeedback_submit_title: 'Allgemeines Feedback senden',
				...
				feedback_mapFeedback_submit_title: 'Feedback zur Karte senden',
