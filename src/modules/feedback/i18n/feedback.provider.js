	...
	switch (lang) {
		case 'en':
			return {
				...
				feedback_mapFeedback_markChangeNotice: 'Edit the map',
		...
		case 'de':
			return {
				...
				feedback_mapFeedback_markChangeNotice: 'Bitte markieren: Auf welche Stelle in der Karte bezieht sich ihr Feedback?',
