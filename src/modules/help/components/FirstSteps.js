/**
 * @module modules/help/components/FirstSteps
 */
...
export class FirstSteps extends MvuElement {
	...
	onInitialize() {
		...
		this.signal(Update_HasBeenVisible, this._environmentService.getQueryParams().get(QueryParameters.T_DISABLE_INITIAL_UI_HINTS) === 'true');
