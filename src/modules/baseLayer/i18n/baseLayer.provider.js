	...
	switch (lang) {
		case 'en':
			return {
				...
				baseLayer_container_category_flurstueck: 'Cadastral data',
				baseLayer_container_scroll_button_flurstueck: 'To the cadastral maps',
		...
		case 'de':
			return {
				...
				baseLayer_container_category_flurstueck: 'Flurstück',
				baseLayer_container_scroll_button_flurstueck: 'Zu den Flurkarten',
