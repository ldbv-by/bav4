...
export class OlMap extends BaElement {
	...
	_buildContextMenueData(evt) {
		const firstCommand = { label: 'Koordinate kopieren', action: () => this.log('I would copy the coordinate if i know how to do it!') };
		const secondCommand = { label: 'Hallo', action: () => this.log('Hello World!') };
