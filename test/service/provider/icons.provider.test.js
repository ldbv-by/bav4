...
describe('Icons provider', () => {
    ...
    it('loads icons', async () => {
        ...
        expect(fooIconTemplateUrl.default).toBe('https://backend.url/icons/50,50,50/foo');
        expect(fooIconTemplateUrl.colored(0, 0, 0)).toBe('https://backend.url/icons/0,0,0/foo');

        const barIconTemplateUrl = icons[1];
        expect(barIconTemplateUrl.default).toBe('https://backend.url/icons/50,50,50/bar');
        expect(barIconTemplateUrl.colored(10, 20, 30)).toBe('https://backend.url/icons/10,20,30/bar');
    });
