...
describe('MapDefinitions provider', () => {
	...
	describe('Bvv mapDefinitions provider', () => {
		...
		it('provides map related meta data', () => {
			const { defaultExtent, srid, defaultSridForView, sridDefinitionsForView, defaultGeodeticSrid, minZoomLevel, maxZoomLevel } = getBvvMapDefinitions();
