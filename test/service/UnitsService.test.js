...
describe('UnitsService', () => {
	...
	it('provides formatted distance for bvv metric system', () => {
		const systemOfUnits = 'bvv_metric';
		...
		expect(instanceUnderTest.formatDistance(999, 0)).toBe('999.0 m');
		expect(instanceUnderTest.formatDistance(1000, 0)).toBe('1.0 km');
		expect(instanceUnderTest.formatDistance(1000, 2)).toBe('1.0 km');
		expect(instanceUnderTest.formatDistance(1234, 0)).toBe('1.2 km');
		expect(instanceUnderTest.formatDistance(1234, 2)).toBe('1.2 km');
		expect(instanceUnderTest.formatDistance(10000, 0)).toBe('10.0 km');
		expect(instanceUnderTest.formatDistance(10000, 2)).toBe('10.0 km');
	});
	...
	it('provides formatted area for bvv-metric system', () => {
		...
		expect(instanceUnderTest.formatArea(42, 0)).toBe('42 m&sup2;');
		expect(instanceUnderTest.formatArea(999, 0)).toBe('999 m&sup2;');
		expect(instanceUnderTest.formatArea(1000000, 0)).toBe('1.000 km&sup2;');
		expect(instanceUnderTest.formatArea(1234567, 0)).toBe('1.230 km&sup2;');
		expect(instanceUnderTest.formatArea(1234567, 2)).toBe('1.230 km&sup2;');
		...
		expect(instanceUnderTest.formatArea(12345, 2)).toBe('12345 m&sup2;');
		expect(instanceUnderTest.formatArea(10000000, 0)).toBe('10.000 km&sup2;');
	});
