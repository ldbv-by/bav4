...
import { highlightCircleStyleFunction, highlightTemporaryCircleStyleFunction, highlightFeatureStyleFunction, highlightTemporaryFeatureStyleFunction, nullStyleFunction } from '../../../../../../../src/modules/map/components/olMap/handler/highlight/StyleUtils';
...
describe('highlightStyleFunction', () => {
	it('should create a style for a point-feature', () => {
		...
		const styles = highlightCircleStyleFunction(feature);
	...
	it('should create a style for a temporary point-feature', () => {
		const geometry = new Point([0, 0]);
		const feature = new Feature({ geometry: geometry });

		const styles = highlightTemporaryCircleStyleFunction(feature);
