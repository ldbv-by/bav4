...
describe('feature.provider', () => {
	...
	it('provides features from sources loaded over http', async () => {
		...
		const kml =
			'<kml xmlns="http://www.opengis.net/kml/2.2" xmlns:gx="http://www.google.com/kml/ext/2.2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/kml/2.2 https://developers.google.com/kml/schema/kml22gx.xsd"><Document><name>Zeichnung</name><Placemark id="marker_1613043377980"><ExtendedData><Data name="type"><value>marker</value></Data></ExtendedData><name></name><description></description><Style><IconStyle><Icon><href>https://geoportal.bayern.de/ba-backend/icons/255,0,0/marker</href><gx:w>48</gx:w><gx:h>48</gx:h></Icon><hotSpot x="24" y="4.799999999999997" xunits="pixels" yunits="pixels"/></IconStyle></Style><Point><altitudeMode>clampToGround</altitudeMode><coordinates>10.877827211723233,49.651146957741275</coordinates></Point></Placemark><Placemark id="marker_1613043382838"><ExtendedData><Data name="type"><value>marker</value></Data></ExtendedData><name></name><description></description><Style><IconStyle><Icon><href>https://geoportal.bayern.de/ba-backend/icons/255,0,0/marker</href><gx:w>48</gx:w><gx:h>48</gx:h></Icon><hotSpot x="24" y="4.799999999999997" xunits="pixels" yunits="pixels"/></IconStyle></Style><Point><altitudeMode>clampToGround</altitudeMode><coordinates>11.26197567556489,49.566766092602606</coordinates></Point></Placemark></Document></kml>';
		...
		spyOn(httpService, 'get')
			...
			.and.returnValue(Promise.resolve(new Response(kml)));
