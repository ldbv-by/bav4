...
describe('i18n for map module', () => {
	it('provides translation for de', () => {
		...
		expect(map.olMap_handler_termsOfUse).toBe(
			'Ihre Zeichnung wird automatisch gespeichert. Durch die Nutzung dieses Dienstes stimmen Sie den <a href="https://www.ldbv.bayern.de/mam/ldbv/dateien/nutzungsbedingungen_geoportal_bayernatlas_bayernatlasplus.pdf" target="_blank" tabindex="0">Nutzungsbedingungen</a> zu.'
		);
