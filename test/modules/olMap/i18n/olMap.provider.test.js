...
describe('i18n for map module', () => {
	it('provides translation for de', () => {
		...
		expect(map.olMap_handler_storage_interrupted).toBe('Speichern wurde unterbrochen. Ihre letzten Änderungen konnten nicht gespeichert werden.');
	...
	it('provides translation for en', () => {
		...
		expect(map.olMap_handler_storage_interrupted).toBe('Saving was interrupted. Your last changes could not be saved.');
