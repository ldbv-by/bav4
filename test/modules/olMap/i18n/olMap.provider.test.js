...
describe('i18n for map module', () => {
	...
	it('provides translation for de', () => {
		...
		expect(map.olMap_handler_mfp_distortion_warning).toBe('Die für den Export verwendete Projektion besitzt in einigen Bereichen\nVerzerrungen die nicht für Längenmessungen geeignet sind.');
	...
	it('provides translation for en', () => {
		...
		expect(map.olMap_handler_mfp_distortion_warning).toBe('The projection used for export has distortions in some areas which are not suitable for length measurements.');
