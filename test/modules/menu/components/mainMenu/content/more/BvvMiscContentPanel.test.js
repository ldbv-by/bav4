...
describe('MiscContentPanel', () => {
	...
	describe('when initialized', () => {
		...
		it('checks all links', async () => {
			...
			expect(links[2].href).toEqual('https://www.geodaten.bayern.de/bayernatlas-info/grundsteuer-nutzungsbedingungen/Nutzungsbedingungen-BayernAtlas-Grundsteuer_01.04.22.pdf');
