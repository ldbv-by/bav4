...
describe('MiscContentPanel', () => {
	...
	describe('when initialized', () => {
		...
		it('checks all links', async () => {
			...
			expect(links[0].querySelector('.ba-list-item__text').innerText).toEqual('misc_content_panel_help');

			expect(links[1].href).toEqual('https://www.ldbv.bayern.de/service/kontakt.html');
			expect(links[1].target).toEqual('_blank');
			expect(links[1].querySelector('.ba-list-item__text').innerText).toEqual('misc_content_panel_Contact');
			...
			expect(links[2].querySelector('.ba-list-item__text').innerText).toEqual('misc_content_panel_terms_of_use');
			...
			expect(links[3].querySelector('.ba-list-item__text').innerText).toEqual('misc_content_panel_privacy_policy');
			...
			expect(links[4].querySelector('.ba-list-item__text').innerText).toEqual('misc_content_panel_imprint');

			expect(links[5].href).toEqual('https://github.com/ldbv-by/bav4-nomigration');
			expect(links[5].target).toEqual('_blank');
			expect(links[5].querySelector('.ba-list-item__text').innerText).toEqual('misc_content_panel_github');

			expect(links[6].href).toEqual('https://geodatenonline.bayern.de/geodatenonline');
			expect(links[6].target).toEqual('_blank');
			expect(links[6].querySelector('.ba-list-item__primary-text').innerText).toEqual('misc_content_panel_gdo_header');
			expect(links[6].querySelector('.ba-list-item__secondary-text').innerText).toEqual('misc_content_panel_gdo_text');

			expect(links[7].href).toEqual('https://www.geoportal.bayern.de/geoportalbayern');
			expect(links[7].target).toEqual('_blank');
			expect(links[7].querySelector('.ba-list-item__primary-text').innerText).toEqual('misc_content_panel_gp_header');
			expect(links[7].querySelector('.ba-list-item__secondary-text').innerText).toEqual('misc_content_panel_gp_text');

			expect(links[8].href).toEqual('https://www.energieatlas.bayern.de/');
			expect(links[8].target).toEqual('_blank');
			expect(links[8].querySelector('.ba-list-item__primary-text').innerText).toEqual('misc_content_panel_ea_header');
			expect(links[8].querySelector('.ba-list-item__secondary-text').innerText).toEqual('misc_content_panel_ea_text');
		});
	});
});
