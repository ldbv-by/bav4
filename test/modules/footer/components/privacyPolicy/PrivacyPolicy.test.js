...
describe('PrivacyPolicy', () => {
	...
	describe('when initialized', () => {
		it('contains a link', async () => {
			...
			expect(element.shadowRoot.querySelectorAll('.privacy_policy-container')).toHaveLength(1);
			expect(element.shadowRoot.querySelectorAll('.privacy-policy-link')).toHaveLength(1);
