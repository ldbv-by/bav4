...
describe('i18n for menu module', () => {
	it('provides translation for de', () => {
		...
		expect(map.toolbox_shareTool_disclaimer).toBe(
			'Sie können die Karte in Ihre Website oder ein Blog einbetten. Mit dem Einbetten dieser Karte stimmen Sie den <a href="https://www.ldbv.bayern.de/mam/ldbv/dateien/nutzungsbedingungen_geoportal_bayernatlas_bayernatlasplus.pdf" target="_blank" tabindex="0"> Nutzungsbedingungen</a> zu.'
		);
		...
		expect(map.toolbox_import_data_subheader).toBe('KML, GPX, GeoJSON, EWKT');
		...
		expect(map.toolbox_import_url_subheader).toBe('WMS, KML, GPX, GeoJSON, EWKT');
