...
describe('BvvCoordinateRepresentations', () => {
	it('provides an enum of all available types', () => {
		...
		expect(BvvCoordinateRepresentations.UTM32).toEqual({ label: 'UTM32', code: 25832, digits: 0, global: false, type: 'utm' });
		expect(BvvCoordinateRepresentations.UTM33).toEqual({ label: 'UTM33', code: 25833, digits: 0, global: false, type: 'utm' });
	});
});
