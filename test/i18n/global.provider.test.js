...
describe('global i18n', () => {
	...
	it('provides translation for en', () => {
		...
		expect(map.global_store_geolocation_denied).toBe('The acquisition of the position failed because your browser settings does not allow it. Allow your browser / this website to use your location. Deactivate the "private" mode of your browser.');
		expect(map.global_store_geolocation_not_available).toBe('The acquisition of the position failed.');
	...
	it('provides translation for de', () => {
		...
		expect(map.global_store_geolocation_denied).toBe('Es ist keine Positionsbestimmung möglich, da ihre Browsereinstellungen dies nicht zulassen. Erlauben sie die Positionsbestimmung und deaktivieren Sie den "Privat" Modus des Browsers.');
		expect(map.global_store_geolocation_not_available).toBe('Es ist keine Positionsbestimmung möglich.');
